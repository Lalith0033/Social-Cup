...
const styles = StyleSheet.create({
  ...
  lineRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: spacing.sm },
  lineLabel: { ...type.body, color: colors.textSecondary },
  lineValue: { ...type.body, color: colors.textPrimary },
  lineLabelStrong: { ...type.bodyStrong, color: colors.textPrimary },
  lineValueStrong: { ...type.bodyStrong, color: colors.brand },
